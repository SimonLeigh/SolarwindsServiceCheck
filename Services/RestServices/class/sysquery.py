...
class GoogleAnalaytics(object):
	...
	def ActiveUser(self):
		command = "cd /Services/GoogleAnalytics && timeout 20 /usr/bin/python n11_analytics_api_v3.py"
	...
	def ActiveUserPerApp(self):
		...
		a = n11_analytics_api_app.main(sys.argv)
